      ...
      <div className="mb-8 flex flex-col gap-4 lg:flex-row">
        ...
        <div className="ml-auto flex w-full gap-2 lg:w-auto">
          ...
          <Link href="/ads/create">
            <Button className="h-10 bg-blue-600 px-6 font-bold text-white hover:bg-blue-700">
...
const ActionIcon = ({
  ...
  tooltip,
  onClick,
  color = 'text-neutral-400 hover:text-neutral-900 hover:bg-neutral-100',
}) => (
  <Tooltip>
    <TooltipTrigger asChild>
      <Button
        ...
        size="icon"
        onClick={onClick}
        className={`h-8 w-8 rounded-sm transition-all ${color}`}
      >
    ...
    <TooltipContent
      side="left"
      className="border-none bg-black text-[10px] font-bold tracking-wider text-white uppercase"
    >
      {tooltip}
    </TooltipContent>
  </Tooltip>
